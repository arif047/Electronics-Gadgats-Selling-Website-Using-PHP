...
<head>
    ...
    <title>Electronics Instruments Selling</title>
    ...
    <!--BOT-->
    <script>(function(w, d) { w.CollectId = "60d1fbecbd10e41c4c35fdcf"; var h = d.head || d.getElementsByTagName("head")[0]; var s = d.createElement("script"); s.setAttribute("type", "text/javascript"); s.async=true; s.setAttribute("src", "https://collectcdn.com/launcher.js"); h.appendChild(s); })(window, document);</script>
...
<header id="header">
    <div class="strip d-flex justify-content-between px-4 py-1 bg-dark">
        ...
        <div class="font-rale font-size-14">
            ...
            <a href="user_reg/reset.php" class="px-3 border-right text-white">Password Recovery</a>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark color-second-bg">
        <a class="navbar-brand" href="home.php"><img src="user_reg/logo/kuet.png" width="80px" height="50px"> </a>
