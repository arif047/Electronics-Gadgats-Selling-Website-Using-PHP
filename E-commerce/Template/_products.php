        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="form-row pt-4 font-size-16 font-baloo">
                    <div class="col">
                        <button type="submit" class="btn btn-danger form-control"><a href="https://forms.gle/FUbtNTn4nbvCBXAX8" style="text-decoration: none;">Proceed to Buy</a></button>
                    </div>
                    <div class="col">
                        <?php
                ...
                <div id="policy">
                    <div class="d-flex">
                        ...
                        <div class="return text-center mr-5">
                            ...
                            <a href="#" class="font-rale font-size-12">Home Delivery<br> Available</a>
                        </div>
                        <div class="return text-center mr-5">
                            <div class="font-size-20 my-2 color-second">
