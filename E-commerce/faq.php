...
<h1>Frequently Asked Question</h1>
    ...
    <div class="accordion">
        <div class="accordion-item">
            ...
            <div class="accordion-item-body">
                <div class="accordion-item-body-content">
                    You can view our site without Registration. But, Registration is compulsury for Placing a order and recieve it.
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-item-body">
                <div class="accordion-item-body-content">
                    Go to Sign-Up Page. Giving proper information and after verifying you can Register.
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item">
            <div class="accordion-item-header">
                What is the available time to make a order?
            </div>
            <div class="accordion-item-body">
                <div class="accordion-item-body-content">
                    24/7
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-item-body">
                <div class="accordion-item-body-content">
                    Mainly, COD:DOC (Cash-On-Delivery). But You can pay through MFS and I-banking Services.
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-item-body">
                <div class="accordion-item-body-content">
                    It takes Nearly 3-4 days.(Depends on Courier Service Company)
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-item-body">
                <div class="accordion-item-body-content">
                    Through Courier Services available in Bangladesh.
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item">
            <div class="accordion-item-header">
                If my products is damaged during transportation, What can I do?
            </div>
            <div class="accordion-item-body">
                <div class="accordion-item-body-content">
                    This is rare case. But, we give the products again with some certain conditions.
                </div>
            </div>
        </div>
        ...
        <div class="accordion-item">
            ...
            <div class="accordion-item-body">
                <div class="accordion-item-body-content">
                    Yes. But, this can be cancelled within 24 hours. Otherwise, this will not be possible.
                </div>
            </div>
        </div>
    </div>
